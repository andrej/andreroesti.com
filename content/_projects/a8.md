---
title: I'll Be There For You! Perpetual Availability in the A⁸ MVX System 
tagline: A. Rösti, S. Volckaert, M. Franz, and A. Voulimeneas, 40th Annual Compuer Security Applications Conference (ACSAC), 2024. **Distinguished Paper Award.**
do_link: true
date: 2024-12-10
category: research
---

<h2 class="section-title">ACSAC 2024 Distinguished Paper</h2> 
<h3>I'll Be There For You! Perpetual Availability in the A⁸ MVX System</h3>

<ul class="horizontal-nav">
<li><a href="{{ 'attachments/a8.pdf' | relative_url }}">{% include icon.html icon='pdf.svg' %} Preprint</a></li>
<li><a href="https://github.com/andrej/a8">{% include icon.html icon='github.svg' %} Github repository</a></li>
<li><a href="https://www.openconf.org/acsac2024/modules/request.php?module=oc_program&action=summary.php&id=73">{% include icon.html icon='link.svg' %} A⁸ on the ACSAC 2024 program</a></li>
</ul>
